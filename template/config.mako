<%!
    ...
    git_link_template = 'https://github.com/ethanabrooks/dollar-lambda/blob/{commit}/{path}#L{start_line}-L{end_line}'
    ...
    #google_search_query = 'inurl:ethanabrooks.github.io/dollar-lambda/ inurl:github.com/ethanabrooks/dollar-lambda'
    google_search_query = ''
