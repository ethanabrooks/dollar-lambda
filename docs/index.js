...
"url":0,
"doc":"A decorator for adding a function as a child of this tree. Parameters      can_run: bool Whether the parser will permit the decorated function to run if no further arguments are supplied. flip_bools: bool Whether to add   no-  before arguments that default to  True . help: dict A dictionary of help strings for the arguments. repeated: Optional[Parser[Sequence[KeyValue[Any  If provided, this parser gets applied repeatedly (zero or more times) at all positions. strings: dict A dictionary of strings to use for the arguments. types: dict A dictionary of types to use for the arguments. Examples     With  flip_bools set to  True : >>> tree = CommandTree()  . >>> @tree.command(flip_bools=True)  . def f1(b: bool = True):  . return dict(f1=dict(b=b  . >>> tree(\"-h\") usage:  no-b b: (default: True) With  flip_bools set to  False : >>> tree = CommandTree()  . >>> @tree.command(flip_bools=False)  . def f1(b: bool = True):  . return dict(f1=dict(b=b  . >>> tree(\"-h\") usage: -b b: (default: True) With  can_run set to  True (the default), we can run  f1 by not passing arguments for the  f1 's children: >>> tree = CommandTree()  . >>> @tree.command(can_run=True)   >> @f1.command()  . def g1(n: int):  . return dict(g1=dict(b=b, n=n  . >>> tree(\"-h\") usage: -b -n N >>> tree(\"-b\") {'f1': {'b': True With  can_run set to  False , the parser will fail if the child function arguments are not supplied: >>> tree = CommandTree()  . >>> @tree.command(can_run=False)   >> @f1.command()  . def g1(n: int):  . return dict(g1=dict(b=b, n=n  . >>> tree(\"-h\") usage: -b -n N >>> tree(\"f1\", \"-b\") usage: -b -n N Expected '-b'. Got 'f1'",
"func":1
},
{
"ref":"dollar_lambda.CommandTree.subcommand",
"url":0,
"doc":"A decorator for adding a function as a child of this tree. As a subcommand, the function's name must be invoked on the command line for the function to be called. Parameters      can_run: bool Whether the parser will permit the decorated function to run if no further arguments are supplied. flip_bools: bool Whether to add   no-  before arguments that default to  True . help: dict A dictionary of help strings for the arguments. repeated: Optional[Parser[Sequence[KeyValue[Any  If provided, this parser gets applied repeatedly (zero or more times) at all positions. strings: dict A dictionary of strings to use for the arguments. types: dict A dictionary of types to use for the arguments. Examples     With  flip_bools set to  True : >>> tree = CommandTree()  . >>> @tree.subcommand(flip_bools=True)  . def f1(b: bool = True):  . return dict(f1=dict(b=b  . >>> tree(\"-h\") usage: f1  no-b b: (default: True) With  flip_bools set to  False : >>> tree = CommandTree()  . >>> @tree.subcommand(flip_bools=False)  . def f1(b: bool = True):  . return dict(f1=dict(b=b  . >>> tree(\"-h\") usage: f1 -b b: (default: True) With  can_run set to  True (the default), we can run  f1 by not passing arguments for the  f1 's children: >>> tree = CommandTree()  . >>> @tree.subcommand(can_run=True)   >> @f1.subcommand()  . def g1(n: int):  . return dict(g1=dict(b=b, n=n  . >>> tree(\"-h\") usage: f1 -b g1 -n N >>> tree(\"f1\", \"-b\") {'f1': {'b': True With  can_run set to  False , the parser will fail if the child function arguments are not supplied: >>> tree = CommandTree()  . >>> @tree.subcommand(can_run=False)   >> @f1.subcommand()  . def g1(n: int):  . return dict(g1=dict(b=b, n=n  . >>> tree(\"-h\") usage: f1 -b g1 -n N >>> tree(\"f1\", \"-b\") usage: f1 -b g1 -n N The following arguments are required: g1",
"func":1
},
{
