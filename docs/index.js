...
"url":0,
"doc":"This checks for the   help or  -h flag before applying  parser . If either of the flags is present, returns the usage message for  parser . >>> p = flag(\"help\", help=\"Print this help message.\").wrap_help() >>> p.parse_args(\" help\") usage:  help help: Print this help message. >>> p.parse_args(\"-h\") usage:  help help: Print this help message. We can use  wrap_help to print partial usage messages, e.g. for subcommands: >>> subcommand1 = equals(\"subcommand1\") >> option(\"option1\").wrap_help() >>> subcommand2 = equals(\"subcommand2\") >> option(\"option2\").wrap_help() >>> p = subcommand1 | subcommand2 >>> p.parse_args(\"subcommand1\", \"-h\") usage:  option1 OPTION1 >>> p.parse_args(\"subcommand2\", \"-h\") usage:  option2 OPTION2",
"func":1
},
{
...
"url":4,
"doc":"SuccessError(usage: str, input: dollar_lambda.sequence.Sequence[str], output: pytypeclass.nonempty_list.NonemptyList[dollar_lambda.parser.Parse[~A )"
},
{
