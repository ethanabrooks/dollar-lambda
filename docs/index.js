...
"url":0,
"doc":"Applies  self zero or more times (like  in regexes). >>> from dollar_lambda import argument, flag >>> p = argument(\"as-many-as-you-like\").many() >>> p.parse_args() {} >>> p = argument(\"as-many-as-you-like\").many() >>> p.parse_args(\"a\") {'as-many-as-you-like': 'a'} >>> p = argument(\"as-many-as-you-like\").many() >>> p.parse_args(\"a\", \"b\") {'as-many-as-you-like': ['a', 'b']} Note that if  self contains  Parser.__or__ , the arguments can be heterogenous: >>> p = flag(\"verbose\") | flag(\"quiet\") >>> p = p.many() >>> p.parse_args(\" verbose\", \" quiet\")  mix  verbose and  quiet {'verbose': True, 'quiet': True}",
"func":1
},
{
"ref":"dollar_lambda.Parser.many1",
"url":0,
"doc":"Applies  self one or more times (like  + in regexes). >>> from dollar_lambda import argument, flag >>> p = argument(\"1-or-more\").many1() >>> p.parse_args(\"1\") {'1-or-more': '1'} >>> p.parse_args(\"1\", \"2\") {'1-or-more': ['1', '2']} >>> p.parse_args() usage: 1-OR-MORE [1-OR-MORE  .] The following arguments are required: 1-or-more",
"func":1
},
{
...
{
"ref":"dollar_lambda.sequence.Colliding",
"url":2,
"doc":"A more or less complete user-defined wrapper around list objects."
},
{
"ref":"dollar_lambda.sequence.partition",
"url":2,
"doc":"Use a predicate to partition entries into false entries and true entries",
"func":1
},
{
"ref":"dollar_lambda.sequence.TreePath",
"url":2,
"doc":"TreePath(parents: 'NonemptyList[str]', leaf: 'A')"
},
{
"ref":"dollar_lambda.sequence.TreePath.parents",
"url":2,
"doc":""
},
{
"ref":"dollar_lambda.sequence.TreePath.leaf",
"url":2,
"doc":""
},
{
"ref":"dollar_lambda.sequence.TreePath.make",
"url":2,
"doc":"",
"func":1
},
{
"ref":"dollar_lambda.sequence.TreePath.merge",
"url":2,
...
{
"ref":"dollar_lambda.sequence.KeyValue",
"url":2,
"doc":"KeyValue(key: 'str', value: 'A_co')"
},
{
"ref":"dollar_lambda.sequence.KeyValue.key",
"url":2,
"doc":""
},
{
"ref":"dollar_lambda.sequence.KeyValue.value",
"url":2,
"doc":""
},
{
...
{
"ref":"dollar_lambda.sequence.Sequence.from_dict",
"url":2,
"doc":"",
"func":1
},
{
"ref":"dollar_lambda.sequence.Sequence.keys",
"url":2,
"doc":"",
"func":1
},
...
{
"ref":"dollar_lambda.sequence.Sequence.to_colliding_dict",
"url":2,
...
{
"ref":"dollar_lambda.sequence.Sequence.to_dict",
"url":2,
...
{
"ref":"dollar_lambda.sequence.Sequence.values",
"url":2,
"doc":"",
"func":1
},
...
{
"ref":"dollar_lambda.sequence.Output",
"url":2,
"doc":"Output(get: 'A_co_monoid')"
},
{
"ref":"dollar_lambda.sequence.Output.get",
"url":2,
"doc":""
},
{
"ref":"dollar_lambda.sequence.Output.from_dict",
"url":2,
"doc":"",
"func":1
},
{
"ref":"dollar_lambda.sequence.Output.zero",
"url":2,
"doc":"",
"func":1
},
