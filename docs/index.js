...
"url":0,
"doc":"Parses a single word and binds it to  dest . Useful for positional arguments. Parameters      dest : str The name of variable to bind to: help : Optional[str] The help message to display for the option: type : Callable str], Any] Use the  type argument to convert the input to a different type: >>> argument(\"name\").parse_args(\"Alice\") {'name': 'Alice'} >>> argument(\"name\").parse_args() usage: NAME The following arguments are required: name",
"func":1
},
{
